...
describe ('SignIn Email Tests', ()=>{
    ...
    test('Email input initialized empty', async ()=>{
        render(<SignIn></SignIn>);
    ...
    test('pass valid email to test email input field pt2', async ()=>{
        render(<SignIn></SignIn>)
        const inputEl = screen.getByTestId("email-input");
        userEvent.type(inputEl, "test@mail.com");
...
describe ('SignIn Password Tests',  ()=>{
    ...
    test('Email password initialized empty', async ()=>{
        render(<SignIn></SignIn>);
    ...
    test('pass valid password to test password input field pt2', async ()=>{
        render(<SignIn></SignIn>)
        const inputEl = screen.getByTestId("password-field");
        userEvent.type(inputEl, "password123");
...
describe ('SignIn Forgot Password Tests',  ()=>{
    ...
    test('SignIn forgot password exists', async () => {
        render(<SignIn></SignIn>);
        expect(screen.getByTestId('forgot-password')).toBeInTheDocument();
    })

    // Test forgot password directs to forgot password page
    test('SignIn forgot password directs to forgot password page', async () => {
        render(<SignIn></SignIn>);
        expect(screen.getByTestId('forgot-password')).toHaveAttribute('href',"/reset");
...
describe ('SignIn Sign Up Tests',  ()=>{
    ...
    test('SignIn Sign Up exists', async () => {
        render(<SignIn></SignIn>);
        expect(screen.getByTestId('sign-up')).toBeInTheDocument();
    })

    // Test sign up directs to sign up page
    test('SignIn  Sign Up directs to  Sign Up page', async () => {
        render(<SignIn></SignIn>);
